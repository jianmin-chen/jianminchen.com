...
<Video className="thin-media" src="https://media.githubusercontent.com/media/jianmin-chen/jianminchen.com/main/public/assets/images/2022-09-03-react-native-pokedex/pokedex.mp4" alt="Video demo of the final app"/>
...
<div className="thin-media">
    ![Hello, World! in React Native](/assets/images/2022-09-03-react-native-pokedex/starter.webp)
</div>
...
<div className="thin-media">
    ![Hello, World! is overlapping with the status bar](/assets/images/2022-09-03-react-native-pokedex/hello-world-broken.webp)
</div>
...
Now, some Pokemon have names that are made up of two or more words. For example, `https://pokeapi.co/api/v2/pokemon/10148` returns the name "pikachu-partner-cap". We want something like "Pikachu (Partner Cap)". Let's switch out `return { name, id, image };` with `return { name: format(name), id, image };` and write a function inside `App.js` that will format these names for us:
...
<div className="thin-media">
    ![Searching up Rayquaza to demonstrate search functionality](/assets/images/2022-09-03-react-native-pokedex/search-functionality.webp)
</div>
...
<div className="thin-media">
    ![Top bar has the name of the current screen and a "My Pokemon" link/button](/assets/images/2022-09-03-react-native-pokedex/navigation-header.webp)
</div>
...
<div className="thin-media">
    ![Appletun has already been added, so the button says "Remove", as expected](/assets/images/2022-09-03-react-native-pokedex/remove-pokemon.webp)
</div>
