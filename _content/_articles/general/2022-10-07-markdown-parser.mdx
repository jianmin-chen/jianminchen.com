...
<Video src="https://media.githubusercontent.com/media/jianmin-chen/blog/main/public/assets/images/2022-10-07-markdown-parser/demo.mp4" alt="Demo of Markdown parser"/>
...
Obviously, the way I implemented the filesystem was probably a bit convoluted. Once the judging period for the Congressional App Challenge is over, I'm definitely going to fix it and add a couple of features. For now, the obligatory demo:

<Video src="https://media.githubusercontent.com/media/jianmin-chen/blog/main/public/assets/images/2022-10-07-markdown-parser/markright-demo.mp4" alt="Markright in action!" />
